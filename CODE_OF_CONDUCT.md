...
**email magne.rasmussen@gmail.com**. Reports are read only by the maintainer, who is currently the
project's sole Community Moderator. Include what happened, where, who was involved, and any links or
logs you have; you may report on someone else's behalf. If your report concerns the maintainer, and
you would rather not write to him directly, say so in a public issue without detail and a neutral
third party will be arranged.
...
For this project, community spaces are the GitHub repository — issues, pull requests, discussions,
code review — and any other channel the project sets up later.
