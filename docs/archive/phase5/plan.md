...
- **Companion:** the HTML mockups in this folder ([`index.html`](../../mockups/index.html)) are the visual target;
...
See [`shortcuts.html`](../../mockups/shortcuts.html) for the full map, focus model, and per-pattern ARIA contract.
