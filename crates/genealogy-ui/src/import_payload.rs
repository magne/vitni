...
/// `genealogy_core::provenance::Confidence`. Serialized kebab-case (`very-low`…`very-high`) to match
...
/// `genealogy_core::text::Rect`. In the confirm stage it is the census line the record was read from,
