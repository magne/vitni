...
pub use view_model::{
    ...
    MediaDetail, NameVm, NoteDetail, ParticipantVm, PartnerVm, PedigreeNodeVm, PedigreeSlotVm, PedigreeVm,
    PersonDetail, PlaceDetail, PlaceHierarchyVm, PlaceLinkVm, PlaceNameVm, RelationshipVm, RepositoryDetail,
    RepositoryLinkVm, SharedAncestorVm, SourceAttributeVm, SourceCitationVm, SourceDetail, SourceHeldVm,
    SourceReliabilityVm, TagDetail, TagUsageGroupVm, TranslationVm, UsingRecordVm, citation_row, citation_tabs,
    collapse_history, dna_match_row, dna_match_tabs, dna_test_row, dna_test_tabs, event_row, event_tabs, evidence_axes,
    family_row, family_tabs, media_row, media_tabs, note_row, note_tabs, person_row, person_tabs, place_row,
