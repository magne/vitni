...
pub use view_model::{
    ...
    PlaceDetail, PlaceDraft, PlaceHierarchyVm, PlaceLinkVm, PlaceMarkerVm, PlaceNameVm, ProvenanceDraft, RecordDraft,
    RecordLink, RelationshipVm, RepositoryDetail, RepositoryDraft, RepositoryLinkVm, RepositoryUrlVm, SharedAncestorVm,
    SourceAttributeVm, SourceCitationVm, SourceDetail, SourceDraft, SourceHeldVm, SourceReliabilityVm,
    TIME_SLIDER_RANGE, TagDetail, TagDraft, TagUsageGroupVm, TimelineKind, TimelineRowVm, TranslationVm, UsingRecordVm,
    citation_row, citation_tabs, clamp_slider_year, collapse_history, dna_match_row, dna_match_tabs, dna_test_row,
