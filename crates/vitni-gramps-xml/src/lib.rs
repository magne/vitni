//! `vitni-gramps-xml` — pure Gramps XML parse/emit over an intermediate model.
//!
//! Mirrors `vitni-gedcom`: the format logic of the Gramps import/export plugins, free of any
