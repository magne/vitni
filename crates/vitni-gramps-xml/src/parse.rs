...
/// Maps a Gramps name-type label onto a [`NameKind`](vitni_interchange::NameKind).
fn name_kind(label: &str) -> vitni_interchange::NameKind {
    use vitni_interchange::NameKind;
    match label.trim() {
