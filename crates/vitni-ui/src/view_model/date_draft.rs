...
//!
//! The parser mirrors the GEDCOM importer's day/month/year reading (`vitni-gedcom`) without
...
#[cfg(test)]
mod tests {
    use vitni_app::{Calendar, DatePoint};
...
mod draft_tests {
    ...
    fn structured(modifier: DateModifier) -> GenealogicalDate {
        build_genealogical_date(vitni_app::DateInput {
            calendar: Calendar::Gregorian,
            quality: DateQuality::Normal,
    ...
    fn new_year_begins_survives_an_untouched_edit() {
        ...
        let seed = build_genealogical_date(vitni_app::DateInput {
