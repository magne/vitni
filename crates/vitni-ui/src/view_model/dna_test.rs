...
pub struct DnaTestDetail {
    ...
    pub genome_build_kind: Option<vitni_app::DnaGenomeBuild>,
...
impl DnaTestDetail {
    /// Builds a detail view from a [`DnaTestSummary`](vitni_app::DnaTestSummary).
    #[must_use]
    pub fn from_summary(summary: &vitni_app::DnaTestSummary, loc: &Localizer) -> Self {
...
/// Builds a list row from a [`DnaTestSummary`](vitni_app::DnaTestSummary): the person name (or id),
/// a `provider · type` subtitle, and a 🧬 avatar.
#[must_use]
pub fn dna_test_row(summary: &vitni_app::DnaTestSummary, loc: &Localizer) -> RowVm {
...
pub struct DnaTestDraft {
    ...
    pub test_type: Option<vitni_app::DnaTestType>,
