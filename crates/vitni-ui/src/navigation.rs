...
impl Category {
    ...
    #[must_use]
    pub fn from_citing_kind(kind: vitni_app::CitingKind) -> Self {
        use vitni_app::CitingKind;
        match kind {
...
/// [`commit_person_change_set`](vitni_app::commit_person_change_set) via
...
/// A request to mutate a place, dispatched to a `vitni-app` command use-case via
...
/// A request to mutate a media object, dispatched to a `vitni-app` command use-case via
...
/// A request to mutate a research note, dispatched to a `vitni-app` command use-case via
...
/// [`create_research_note`](vitni_app::create_research_note) (plus a follow-up body assert) via
...
/// to [`commit_tag_change_set`](vitni_app::commit_tag_change_set) via
...
/// [`commit_source_change_set`](vitni_app::commit_source_change_set) via
...
/// [`commit_repository_change_set`](vitni_app::commit_repository_change_set) via
...
/// [`commit_note_change_set`](vitni_app::commit_note_change_set) via
...
/// [`commit_media_change_set`](vitni_app::commit_media_change_set) via
...
/// [`commit_place_change_set`](vitni_app::commit_place_change_set) via
...
/// [`commit_family_change_set`](vitni_app::commit_family_change_set) via
...
/// [`commit_citation_change_set`](vitni_app::commit_citation_change_set) via
...
/// [`observe_dna_match`](vitni_app::observe_dna_match) via
...
/// [`commit_event_change_set`](vitni_app::commit_event_change_set) via
