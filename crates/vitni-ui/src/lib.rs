...
pub use view_model::{
    ...
    MapPointVm, MarkerShapeVm, MediaAttributeVm, MediaDetail, MediaDraft, MediaRefVm, MediaSaveDraft, MergeBlockedVm,
    MergeCompareVm, MergeFailure, MergeFieldRowVm, MergeResultVm, NEW_EVENT_TYPES, NEW_PLACE_TYPES, NameVm,
    NewCitationFields, NewEventFields, NewMediaFields, NewNoteFields, NewPersonFields, NewPlaceFields, NewRecordDraft,
    ...
    plugin_grant_vm, rect_contains, rect_css, rect_from_drag, rect_moved, rect_resized, repository_row,
    repository_tabs, research_note_row, research_note_tabs, resolve_attach_save, resolve_geometry_as_of, shortcuts_vm,
    slugify, source_row, source_tabs, suggest_filename, tag_row, tag_tabs, toggled_restrictions, trust_store_vm,
};
pub use vocabulary::{
