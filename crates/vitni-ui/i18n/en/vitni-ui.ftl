...
history-geometry-asserted = Geometry asserted
history-succession-asserted = Succession asserted
...
picker-entity-family = family
picker-entity-tag = tag
...
place-map-none-as-of = No geometry as of { $year }.
place-geometry-effective-label = Effective date
place-geometry-effective-undated = Undated — applies to every year
place-geometry-effective-dated = As of { $year }
...
place-succession-title = Succession
place-succession-note = Identity changes — a merge or split reaches different place records, navigable both ways.
place-succession-add = Add succession
place-succession-add-title = Assert a merge / split / absorb link to other places
place-succession-kind-field = Kind of change
place-succession-to-field = Resulting place
place-succession-from-field = Also ceased
place-succession-add-picked = Add picked place
succession-kind-merged = merged
succession-kind-split = split
succession-kind-absorbed = absorbed
succession-kind-elevated = elevated
succession-kind-renamed = renamed
...
action-edit-row = Edit { $row }
action-cite-row = Cite { $row }
action-retract-row = Retract { $row }
action-detach-row = Detach { $row }
action-remove-tag-named = Remove tag { $name }
retract-title = Retract this assertion — it stays in History
detach-media-title = Detach this media — the detachment is recorded in History
...
remove-child-title = Remove this child from the family — the membership ended; recorded in History
retract-child-title = Retract this child claim — the membership was recorded in error; it stays in History
...
panel-edit-address = Edit address
...
plugin-grant-pending = Needs approval
plugin-grants-heading = Capability grants
plugin-action-approve-all = Approve all declared
plugin-action-save-grants = Save grants
plugin-trust-store-heading = Trusted publishers
plugin-trust-store-empty = No publisher is pinned. Add a publisher key to trust their signed plugins.
plugin-trust-publisher-label = Publisher
