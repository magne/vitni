...
history-geometry-asserted = Geometri fastslått
history-succession-asserted = Etterfølgelse fastslått
...
picker-entity-family = familie
picker-entity-tag = etikett
...
place-map-none-as-of = Ingen geometri per { $year }.
place-geometry-effective-label = Gjelder fra
place-geometry-effective-undated = Udatert — gjelder for alle år
place-geometry-effective-dated = Fra og med { $year }
...
place-succession-add = Legg til etterfølgelse
place-succession-add-title = Fastslå en sammenslåing / deling / innlemming til andre steder
place-succession-kind-field = Type endring
place-succession-to-field = Resulterende sted
place-succession-from-field = Opphørte også
place-succession-add-picked = Legg til valgt sted
...
field-typical-confidence = Typisk sikkerhet
field-type = Type
field-street = Gate
field-locality = Sted
field-region = Region
...
place-coordinate-invalid = Skriv inn en gyldig koordinat.
...
action-remove = Fjern
action-unlink = Koble fra
action-detach = Koble fra
action-edit-row = Rediger { $row }
action-cite-row = Siter { $row }
action-retract-row = Trekk tilbake { $row }
action-detach-row = Koble fra { $row }
action-remove-tag-named = Fjern etikett { $name }
retract-title = Trekk tilbake denne påstanden — den blir værende i historikken
detach-media-title = Koble fra dette mediet — frakoblingen registreres i historikken
...
remove-child-title = Fjern dette barnet fra familien — tilhørigheten er avsluttet; registreres i historikken
retract-child-title = Trekk tilbake denne barnepåstanden — tilhørigheten ble registrert ved en feil; den blir værende i historikken
...
panel-edit-address = Rediger adresse
...
plugin-cap-ai = ki
plugin-cap-present = presenter
plugin-grant-pending = Trenger godkjenning
plugin-grants-heading = Kapabilitetstildelinger
plugin-action-approve-all = Godkjenn alle deklarerte
plugin-action-save-grants = Lagre tildelinger
plugin-trust-store-heading = Betrodde utgivere
plugin-trust-store-empty = Ingen utgiver er festet. Legg til en utgivernøkkel for å stole på deres signerte tillegg.
plugin-trust-publisher-label = Utgiver
