//! `vitni-app` — the application coordination layer (ADR 0006).
//!
//! This crate sits between the pure domain core (`vitni-core`) / engine-neutral event store
//! (`vitni-db`) and the frontends (`vitni-cli` today; a UI and web backend later). It owns
...
pub use config_store::{
    ConfigStore, FileConfigStore, Presentation, WorkspaceFunctionality, requested_languages_for,
    resolve_requested_languages, vitni_language_env,
};
pub use dna_match::{
...
pub use vitni_core::address::Address;
pub use vitni_core::age::{Age, AgeBound};
pub use vitni_core::citation::CitationError;
pub use vitni_core::date::{
    Calendar, DateModifier, DatePoint, DateQuality, GenealogicalDate, GenealogicalDateBody, TimeOfDay,
};
pub use vitni_core::dna::{
    Centimorgans, ChromosomeSide, DnaGenomeBuild, DnaProvider, DnaSegment, DnaTestType, PercentShared, SharedAncestor,
};
pub use vitni_core::dna_match::{DnaMatchError, MatchStatus};
pub use vitni_core::dna_test::DnaTestError;
pub use vitni_core::enums::{
...
pub use vitni_core::event::EventError;
pub use vitni_core::fact::Fact;
...
pub use vitni_core::media_path::mime_for_path;
...
pub use vitni_core::repository::RepositoryError;
pub use vitni_core::research_note::{ResearchNoteError, SubjectRef};
pub use vitni_core::source::SourceError;
pub use vitni_core::tag::TagError;
pub use vitni_core::temporal::resolve_as_of;
