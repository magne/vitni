...
use vitni_core::enums::{AssociationRole, EventType, EvidenceLevel, FactType, ParticipantRole, Restriction, Sex};
...
/// [`PersonError::EmptyName`](vitni_core::person::PersonError).
