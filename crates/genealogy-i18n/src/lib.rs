//! Shared Fluent localization plumbing for the genealogy frontends (ADR 0003).
//!
...
//!
//! This crate has no dependency on any other genealogy crate (the shared-override directory is
