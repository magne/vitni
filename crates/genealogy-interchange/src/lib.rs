//! `genealogy-interchange` — the format-neutral value vocabulary shared by import/export formats.
//!
//! These are the *leaf* value types every record-interchange format (`genealogy-gedcom`,
//! `genealogy-gramps-xml`, the assisted-import `genealogy-digitalarkivet` crate, a future GEDCOM X
...
//! concerns belong to `genealogy-core`'s domain types; this crate is the lossy interchange shape the
