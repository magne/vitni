...
use dioxus::prelude::*;
use vitni_app::{MapBasemap, MapProvider, MapSource};
use vitni_ui::{EventPinVm, GeographyVm, MarkerShapeVm, PlaceMarkerVm, PlaceRowStatus, PlaceRowVm};
...
fn an_unconfigured_map_offers_only_the_built_in_default() {
    let cfg = vitni_app::MapConfig::default();
