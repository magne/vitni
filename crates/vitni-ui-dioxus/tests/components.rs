...
use vitni_ui_dioxus::components::{
...
fn gallery() -> Element {
    rsx! {
        ...
        Breadcrumb { segments: vec!["Vitni".to_owned(), "People".to_owned()] }
...
fn draft_date_range_edit() -> Element {
    use vitni_ui::{DateDraft, DateModifierKind};
    use vitni_ui_dioxus::components::DraftDate;
