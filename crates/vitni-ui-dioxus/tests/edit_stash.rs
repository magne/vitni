...
use dioxus::prelude::*;
use vitni_ui::{Category, NoteDraft, ProvenanceDraft, RecordRef, TagDraft};
use vitni_ui_dioxus::screens::{use_record_create, use_record_edit};
use vitni_ui_dioxus::shell::nav_state::{DraftId, EditKey, NavState, StashedEdit};
...
enum PaneAction {
    ...
    Type,
    /// Cancel the edit session ([`vitni_ui_dioxus::screens::RecordEditState::cancel`]).
    Cancel,
