...
use vitni_app::{BUILT_IN_MAP_PROVIDER, MapConfig, MapProvider, MapSource, PlaceGeometry, PlaceType};
use vitni_ui::{
...
/// existing place change-set (the point rides in [`vitni_ui::PlaceChangeSetRequest::coordinates`]
...
mod tests {
    ...
    use vitni_app::{MapProvider, PlaceGeometry};
    use vitni_ui::{EventPinVm, GeographyVm, MarkerShapeVm, PlaceMarkerVm};
