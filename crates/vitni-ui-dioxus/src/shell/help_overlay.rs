...
//!
//! Renders the *resolved* shortcut map (`vitni_ui::resolved_shortcuts`, ADR 0030 §1 — so a
...
use dioxus::prelude::*;
use vitni_ui::{Chord, Key as ChordKey, Modifier, Shortcut, ShortcutGroup, navigation_shortcuts};
