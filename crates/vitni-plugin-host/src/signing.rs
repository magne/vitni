...
pub struct PluginManifest {
    ...
    /// The `vitni:host-api` package version the plugin was built against.
    pub host_api: String,
...
const BUNDLE_DOMAIN: &[u8] = b"vitni-plugin-bundle-v1";
...
pub const SIGNING_KEY_ENV: &str = "VITNI_PLUGIN_SIGNING_KEY";
...
const DEV_SEED: [u8; 32] = *b"vitni-dev-signing-key-seed!!!!!!";
...
pub const DEV_PUBLIC_KEY: [u8; 32] = [
    0x69, 0xe4, 0x50, 0x53, 0xc1, 0xc0, 0x4b, 0x21, 0x6c, 0xf4, 0x13, 0x8e, 0xd2, 0x06, 0x4e, 0x2f, 0x68, 0xfc, 0x05,
    0xba, 0xfc, 0x4e, 0x6c, 0xf0, 0xcc, 0x5c, 0xca, 0x19, 0xb5, 0x58, 0x4e, 0xe7,
];
