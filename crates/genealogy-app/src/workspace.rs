...
mod tests {
    use super::{
        ...
        read_plugin_preferences, read_ui_preferences, resolve_database_url, resolve_init_database_url,
        resolve_ui_preferences, save_plugin_enabled, save_recent, save_theme_mode, save_window_geometry,
    };
