...
//! `genealogy-plugin-host`, which sits **above** this crate (so this crate cannot depend on it): a
...
/// directories skipped — exactly as `genealogy_i18n::layered_assets` skips absent i18n dirs.
///
