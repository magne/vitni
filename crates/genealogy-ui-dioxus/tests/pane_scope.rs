...
use genealogy_ui_dioxus::screens::use_record_undo;
use genealogy_ui_dioxus::shell::nav_state::{EditKey, NavState, PaneRole};
...
fn undoable_entry() -> Vec<genealogy_ui::HistoryEntryVm> {
    vec![genealogy_ui::HistoryEntryVm {
