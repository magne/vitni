...
macro_rules! for_each_db_aggregate {
    ($callback:ident) => {
        $callback! {
            ...
            (place, genealogy_core::place::PlaceState, genealogy_core::place::PlaceView, genealogy_core::place::PlaceCommandEnvelope, genealogy_core::place::PlaceError, PLACE_VIEW_TABLE, "place_view", execute_place, find_place, human_id, list_places, (resolver crate::resolver::SqlitePlaceRefResolver), Vec::new(),),
            (source, genealogy_core::source::SourceState, genealogy_core::source::SourceView, genealogy_core::source::SourceCommandEnvelope, genealogy_core::source::SourceError, SOURCE_VIEW_TABLE, "source_view", execute_source, find_source, human_id, list_sources, (resolver crate::resolver::SqliteSourceRefResolver), Vec::new(),),
            (citation, genealogy_core::citation::CitationState, genealogy_core::citation::CitationView, genealogy_core::citation::CitationCommandEnvelope, genealogy_core::citation::CitationError, CITATION_VIEW_TABLE, "citation_view", execute_citation, find_citation, human_id, list_citations, (resolver crate::resolver::SqliteCitationRefResolver), Vec::new(),),
            (event, genealogy_core::event::EventState, genealogy_core::event::EventView, genealogy_core::event::EventCommandEnvelope, genealogy_core::event::EventError, EVENT_VIEW_TABLE, "event_view", execute_event, find_event, human_id, list_events, (event crate::resolver::SqliteEventRefResolver), genealogy_core::event::upcasters(),),
            (dna_test, genealogy_core::dna_test::DnaTestState, genealogy_core::dna_test::DnaTestView, genealogy_core::dna_test::DnaTestCommandEnvelope, genealogy_core::dna_test::DnaTestError, DNA_TEST_VIEW_TABLE, "dna_test_view", execute_dna_test, find_dna_test, human_id, list_dna_tests, (resolver crate::resolver::SqliteDnaTestRefResolver), Vec::new(),),
            (dna_match, genealogy_core::dna_match::DnaMatchState, genealogy_core::dna_match::DnaMatchView, genealogy_core::dna_match::DnaMatchCommandEnvelope, genealogy_core::dna_match::DnaMatchError, DNA_MATCH_VIEW_TABLE, "dna_match_view", execute_dna_match, find_dna_match, human_id, list_dna_matches, (resolver crate::resolver::SqliteDnaMatchRefResolver), Vec::new(),),
