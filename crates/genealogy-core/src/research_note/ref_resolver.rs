...
//! `Services` type can name it; the SQLite/Postgres implementation lives in `genealogy-db`, which
...
///
/// Implemented by `genealogy-db` over the Person/Family/Event/Place projections; the `cqrs-es`
