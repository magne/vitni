...
wit_bindgen::generate!({
    ...
    with: {
        "genealogy:host-api/types@0.15.0": genealogy_plugin_api::types,
        "genealogy:host-api/log@0.15.0": genealogy_plugin_api::log,
        "genealogy:host-api/commands@0.15.0": genealogy_plugin_api::commands,
        "genealogy:host-api/progress@0.15.0": genealogy_plugin_api::progress,
        "genealogy:host-api/import-source@0.15.0": genealogy_plugin_api::import_source,
    },
});
