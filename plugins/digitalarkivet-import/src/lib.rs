...
wit_bindgen::generate!({
    ...
    with: {
        ...
        "genealogy:host-api/net@0.19.0": genealogy_plugin_api::net,
        "genealogy:host-api/media-store@0.19.0": genealogy_plugin_api::media_store,
        "genealogy:host-api/ai@0.19.0": genealogy_plugin_api::ai,
        "genealogy:host-api/present@0.19.0": genealogy_plugin_api::present,
    },
});
